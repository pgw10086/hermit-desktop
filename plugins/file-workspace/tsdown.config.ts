...
const PACKAGE_NAME = '@hermit/file-workspace'
const CSS_PREFIX = '\0hermit-file-workspace-css:'
...
export default defineConfig([
  {
    ...
    clean: false,
    sourcemap: true,
    deps: { neverBundle: (id: string) => id === '@deepseek-ai/cordis' },
  },
  {
    ...
    plugins: [{
      name: 'hermit-file-workspace-css-modules-inline',
