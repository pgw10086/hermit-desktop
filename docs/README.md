...
- 仓库所有权：[仓库布局](repository-layout.md)
- 系统和进程所有权：[系统边界](architecture/system-boundaries.md)
- DSH 公共集成：[DSH 集成契约](contracts/dsh-integration.md)
- 产品插件信任：[产品插件安全契约](contracts/product-plugin-security.md)
...
`docs/` 保存长期有效、面向维护者的事实；normative machine schema 放在 `specs/`；
生成 evidence 放在已忽略的 `.hermit/artifacts/`。
